        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu">
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        <li class="slide-item"><a href="{{ route('user.add') }}">Add User</a></li>
                        <li class="slide-item"><a href="{{ route('user.manage') }}">Manage User</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li class="slide-item"><a href="{{ route('category.add') }}">Add Category</a></li>
                        <li class="slide-item"><a href="{{ route('category.manage') }}">Manage Category</a></li>
                    </ul>
                </li>
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="#">
                    ...
                    <ul class="slide-menu">
                        <li class="slide-item"><a href="{{ route('product.add') }}">Add Product</a></li>
                        <li class="slide-item"><a href="{{ route('product.manage') }}">Manage Product</a></li>
                    </ul>
                </li>
            </ul>
