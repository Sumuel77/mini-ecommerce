                    ...
                    <div class="product-sidebar">
                        ...
                        <div class="single-widget">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    <a href="{{route('product.category',[ 'catId' => $category->id]) }}">{{ $category->name }}</a>
                                </li>
                                @endforeach
                            </ul>
                        </div>
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{asset('website-assets')}}/assets/images/products/product-1.jpg" alt="#">
                                                        <div class="button">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{asset('website-assets')}}/assets/images/products/product-2.jpg" alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{asset('website-assets')}}/assets/images/products/product-4.jpg" alt="#">
                                    ...
                                    <div class="col-lg-12 col-md-12 col-12">
                                        ...
                                        <div class="single-product">
                                            <div class="row align-items-center">
                                                <div class="col-lg-4 col-md-4 col-12">
                                                    <div class="product-image">
                                                        <img src="{{asset('website-assets')}}/assets/images/products/product-7.jpg" alt="#">
